...
export const mockDetail = {
  backImgPath: undefined,
  title: 'Fight Club',
  id: 550,
  overview:
    'A ticking-time-bomb insomniac and a slippery soap salesman channel primal male aggression into a shocking new form of therapy. Their concept catches on, with underground "fight clubs" forming in every town, until an eccentric gets in the way and ignites an out-of-control spiral toward oblivion.',
  genres: ['Drama'],
  posterPath: 'https://image.tmdb.org/t/p/w200null',
  runtime: '2h 19m',
...
export const mockMovies = [
  {
    backImgPath:
      'https://image.tmdb.org/t/p/w400/hbn46fQaRmlpBuUrEiFqv0GDL6Y.jpg',
    title: 'The Avengers',
    id: 24428,
    overview:
      'When an unexpected enemy emerges and threatens global safety and security, Nick Fury, director of the international peacekeeping agency known as S.H.I.E.L.D., finds himself in need of a team to pull the world back from the brink of disaster. Spanning the globe, a daring recruitment effort begins!',
  ...
  {
    backImgPath:
      'https://image.tmdb.org/t/p/w400/8YW4rwWQgC2JRlBcpStMNUko13k.jpg',
    title: 'The Avengers',
    id: 9320,
    overview:
      'British Ministry agent John Steed, under direction from "Mother", investigates a diabolical plot by arch-villain Sir August de Wynter to rule the world with his weather control machine. Steed investigates the beautiful Doctor Mrs. Emma Peel, the only suspect, but simultaneously falls for her and joins forces with her to combat Sir August.',
  ...
  {
    backImgPath:
      'https://image.tmdb.org/t/p/w400/570qhjGZmGPrBGnfx70jcwIuBr4.jpg',
    title: 'Avengers: Age of Ultron',
    id: 99861,
    overview:
      'When Tony Stark tries to jumpstart a dormant peacekeeping program, things go awry and Earth’s Mightiest Heroes are put to the ultimate test as the fate of the planet hangs in the balance. As the villainous Ultron emerges, it is up to The Avengers to stop him from enacting his terrible plans, and soon uneasy alliances and unexpected action pave the way for an epic and unique global adventure.',
  ...
  {
    backImgPath: 'https://image.tmdb.org/t/p/w400null',
    title: 'Avengers of the Reef',
    id: 392031,
    overview:
      "This Australian children's film is about scientist Bill Stewart goes to Fiji with his son Tim to investigate the appearance of the Crown of Thorns starfish in the reefs off the island.",
  ...
  {
    backImgPath:
      'https://image.tmdb.org/t/p/w400/85NqI4WuCim6dZexmTPUAi13Af0.jpg',
    title: 'Ultimate Avengers 2',
    id: 14611,
    overview:
      'Mysterious Wakanda lies in the darkest heart of Africa, unknown to most of the world. An isolated land hidden behind closed borders, fiercely protected by its young king - the Black Panther. But when brutal alien invaders attack, the threat leaves the Black Panther with no option but to go against the sacred decrees of his people and ask for help from outsiders.',
  ...
  {
    backImgPath:
      'https://image.tmdb.org/t/p/w400/mZO4V0ALx15QTgWr4SaXYGT7i60.jpg',
    title: 'Ultimate Avengers',
    id: 14609,
    overview:
      'When a nuclear missile was fired at Washington in 1945, Captain America managed to detonate it in the upper atmosphere. But then he fell miles into the icy depths of the North Atlantic, where he remained lost for over sixty years. But now, with the world facing the very same evil, Captain America must rise again as our last hope for survival.',
  ...
  {
    backImgPath:
      'https://image.tmdb.org/t/p/w400/6ajw8PjpnelE6l28VZRB6PX4KM.jpg',
    title: 'The New Adventures of the Elusive Avengers',
    id: 65591,
    overview:
      'A brilliant continuation of the saga, now in the city. The target of young patriots is a map held in the safe locker in the headquarters of secret police!',
  ...
  {
    backImgPath:
      'https://image.tmdb.org/t/p/w400/cx3GroQGuwJGYfhD13iLyNMV9X8.jpg',
    title: 'The Shaolin Avengers',
    id: 109088,
    overview:
      "The famous story of the Shaolin Temple's betrayal by the White-Browed Hermit, and the subsequent revenge by Shaolin firebrand Fang Shih-yu, is the stuff of legend. It has been filmed many times by many directors, but few are remembered as fondly as this production. The potent combination of director Chang Cheh and international idol Alexander Fu Sheng caught lightning in a lens.",
  ...
  {
    backImgPath:
      'https://image.tmdb.org/t/p/w400/cd3VcJBzLJs3gjX0LpE1ZL7hHqs.jpg',
    title: 'The Day Will Dawn',
    id: 64128,
    overview:
      'Horse race tipster and journalist Metcalfe is picked for the job of foreign correspondent in Norway when Hitler invades Poland. On the way to Norway his boat is attacked by a German U-Boat, however when he tells the navy about it they disbelief him and, to make matters worse, he is removed from his job. When German forces invade Norway, Metcalfe returns determined to uncover what is going on and stop the Germans in their tracks.',
  ...
  {
    backImgPath:
      'https://image.tmdb.org/t/p/w400/5nwuBYksiGkrACCVgq086L9zwWm.jpg',
    title: 'Crippled Avengers',
    id: 40081,
    overview:
      'Crippled Avengers is a 1978 Shaw Brothers kung fu film directed by Chang Cheh and starring four members of the Venom Mob. It has been released in North America as Mortal Combat and Return of the 5 Deadly Venoms. The film follows a group of martial artists seeking revenge after being crippled by Tu Tin-To (Chen Kuan Tai), a martial arts master, and his son (Lu Feng).',
  ...
  {
    backImgPath:
      'https://image.tmdb.org/t/p/w400/yeKT2gNFxHGbTT3Htj5PE9IerGJ.jpg',
    title: 'Marvel Studios: Building a Cinematic Universe',
    id: 161097,
    overview:
      'Feature-length documentary about the rise of Marvel Studios and their films leading up to, and including, The Avengers.',
